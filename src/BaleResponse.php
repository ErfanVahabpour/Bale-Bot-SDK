 ...
 * Class BaleResponse.
 *
 * Handles the response from Bale API.
 */
final class BaleResponse
{
    ...
    /** @var BaleSDKException The exception thrown by this request. */
    private BaleSDKException $thrownException;
     ...
     */
    public function __construct(/** @var BaleRequest The original request that returned this response. */
        private BaleRequest $request, $response)
    {
    ...
    {
        $this->thrownException = BaleResponseException::create($this);
    }

    /**
     * Return the original request that returned this response.
     */
    public function getRequest(): BaleRequest
    {
        return $this->request;
    }
     ...
     */
    public function throwException(): BaleSDKException
    {
     ...
     */
    public function getThrownException(): BaleSDKException
    {
