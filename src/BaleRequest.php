 ...
 * Class BaleRequest.
 *
 * Builds Bale Bot API Request Entity.
 */
final class BaleRequest
{
    ...
    public function validateAccessToken(): void
    {
        if ($this->accessToken === null) {
            throw new BaleSDKException('You must provide your bot access token to make any API requests.');
        }
    }
    ...
    public function validateMethod(): void
    {
        if ($this->method === '' || $this->method === '0') {
            throw new BaleSDKException('HTTP method not specified.');
        }

        if (! in_array($this->method, ['GET', 'POST'])) {
            throw new BaleSDKException('Invalid HTTP method specified. Must be GET or POST');
        }
    }
    ...
    {
        return [
            'User-Agent' => 'Bale Bot PHP SDK v'.Api::VERSION.' (https://github.com/ErfanVahabpour/Bale-Bot-SDK)',
        ];
    }
