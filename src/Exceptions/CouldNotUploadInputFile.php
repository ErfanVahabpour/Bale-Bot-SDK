 ...
 */
final class CouldNotUploadInputFile extends BaleSDKException
{
    ...
    {
        return new self(sprintf('Input field [%s] is missing in your params. Please make sure it exists and is an `EFive\Bale\FileUpload\InputFile` entity.', $inputFileField));
    }
}