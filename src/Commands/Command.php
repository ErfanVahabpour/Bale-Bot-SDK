...
use EFive\Bale\Answers\Answerable;
use EFive\Bale\Api;
...
abstract class Command implements CommandInterface
{
    ...
    /** @var string The Bale command description. */
     ...
     */
    public function make(Api $bale, Update $update, array $entity): mixed
    {
        $this->bale = $bale;
        $this->update = $update;
        $this->entity = $entity;
    ...
    {
        return $this->bale->getCommandBus();
    }
}