...
return [
    ...
    |
    | Here are each of the bale bots config parameters.
    |
    | Supported Params:
    |
    | - name: The *personal* name you would like to refer to your bot as.
    |
    |       - token:    Your Bale Bot's Access Token.
    |                   Refer for more details: https://blog.bale.ai/making-a-bot/
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('BALE_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'certificate_path' => env('BALE_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('BALE_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            /*
             * @see https://docs.bale.ai/#update
             */
            'allowed_updates' => null,
            'commands' => [
                //Acme\Project\Commands\MyBaleBot\BotCommand::class
            ],
        ],
    ...
    */
    ...
    | Should be an instance of \Bale\Bot\HttpClients\HttpClientInterface
    |
    | Default: GuzzlePHP
    |
    */
    ...
    | Should be a local bot api endpoint or a proxy to the bale api endpoint
    |
